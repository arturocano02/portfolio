...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 py-6 px-6 backdrop-blur-sm bg-black bg-opacity-20">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="flex items-center space-x-6">
          <div className="relative" ref={dropdownRef}>
            ...
            {isDropdownOpen && (
              <div 
                className="absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-black bg-opacity-90 backdrop-blur-md border border-gray-700"
