    ...
    <>
      ...
      <section className="min-h-screen flex items-center justify-center pt-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold mb-8" style={{ lineHeight: '1.4', paddingBottom: '0.3em' }}>
            designing and<br/>
      ...
      <section className="py-20 glass border-t border-white border-opacity-10">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="mb-6">
            <a href="mailto:arturocanodesigns@gmail.com" className="text-white hover:underline text-lg flex items-center justify-center gap-2">
